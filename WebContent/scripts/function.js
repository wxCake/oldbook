...
function check2(){
	...
	document.getElementById("sp").style.display="inline";
		if(str=='false'){
			document.getElementById("sp").innerHTML="<font color='red'>×</font>";
			document.getElementById("sub").disabled=true;
		}else{
			document.getElementById("sp").innerHTML="<font color='green'>√</font>";
...
function Checknum2(){
	if(ajax.readyState==4 && ajax.status==200){
		...
		if(str=='false'){
			...
			document.getElementById("msg").innerHTML="<font color='green'>输入正确</font>";
			document.getElementById("sub").disabled=false;
		}
	}
}