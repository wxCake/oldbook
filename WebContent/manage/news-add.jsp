...
<body>
	<div id="header" class="wrap">
		...
		<div class="navbar">
			<ul class="clearfix">
				...
				<li class="current"><a href="newsselect">公告</a></li>
			</ul>
		</div>
	</div>
	<div id="childNav">
	...
	<div id="position" class="wrap">
		您现在的位置：<a href="index.jsp">校园旧书交易</a> &gt; 发布公告
	</div>
	<div id="main" class="wrap">
		<div class="main">
			<h2>发布公告</h2>
			<div class="manage" style="margin: 50px auto">
				<form action="insertnews">
					<table class="form">
						<tr>
							<td class="field" style="font-size: 18px">公告标题：</td>
							<td><input type="text" class="text" name="title" value="" /></td>
						</tr>
						<tr>
							<td class="field" style="font-size: 18px">公告内容：</td>
							<td><textarea name="content"></textarea></td>
						</tr>
						<tr>
							<td></td>
							<td><label class="ui-blue"><input type="submit"
									name="submit" value="发布" /></label></td>
						</tr>
					</table>
				</form>
			</div>
